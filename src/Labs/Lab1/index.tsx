    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Flip with spatula when pan side of egg is solid</li>
          <li>Remove egg when it is firm enough to be picked up by spatula</li>
        </ol>
      ...
      Please
      <a href="https://github.com/gcalianese/kambaz-react-web-app/tree/a2" id="wd-github"> click here </a>to get to GitHub repo<br />
