...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item> <Nav.Link href="https://github.com/gcalianese/kambaz-node-server-app/tree/a5" target="_blank" id="wd-github-server" active={pathname.includes("server")}> My Server </Nav.Link> </Nav.Item>
    </Nav>
  );
}
